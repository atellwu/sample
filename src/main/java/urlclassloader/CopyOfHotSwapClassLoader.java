 ...
 */
public class CopyOfHotSwapClassLoader extends URLClassLoader {

	public CopyOfHotSwapClassLoader(URL[] urls) {
		super(urls);
	}

	public CopyOfHotSwapClassLoader(URL[] urls, ClassLoader parent) {
		super(urls, parent);
	}
	...
	public Class reload(String name, boolean resolve)
			throws ClassNotFoundException {
		return new CopyOfHotSwapClassLoader(super.getURLs(), super.getParent()).load(
				name, resolve);
	}
}